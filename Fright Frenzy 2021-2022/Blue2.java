...
@Autonomous(name="Blue2", group="concept")  // @TeleOp(...) is the other common choice
//@Disabled
public class Blue2 extends LinearOpMode {
    ...
    public void intake(double power, long time) throws InterruptedException
    {
        //robot.intake.setPosition(power);
        Thread.sleep(time);
    }
